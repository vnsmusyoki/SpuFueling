...
?>
<?php
$tankid = $_GET['supplier'];
include '../db-conection.php';
$bookings = "SELECT * FROM `suppliers` WHERE `supplier_id` = '$tankid'";
...
if ($bookingsrows >= 1) {
    while ($fetch  = mysqli_fetch_assoc($querybookings)) {
        $globalid = $fetch['supplier_id'];
        $globalname = $fetch['supplier_name'];
        $globalcompany = $fetch['supplier_company'];
        $globalphonenumber = $fetch['supplier_phone_number'];
        $globalemail = $fetch['supplier_email'];
    }
    global $globalname;
                                    ...
                                    <form class="forms-sample" action="" method="POST" autocomplete="off" ">
                                      <?php
                                        ...
                                        if (isset($_POST["createaccount"])) {
                                            ...
                                            require 'functions/edit-supplier-validation.php';
                                        }
                                        ?>
                                        <?php echo $message; ?>
                                        <div class=" row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputName1"
                                                    placeholder="Name" name="company"
                                                    value="<?php echo $globalcompany; ?>">
                                            </div>
                                        </div>
                                        <input type="hidden" name="supplier_id" id="" value="<?php echo $globalid; ?>">
                                        <div class="col-12">
                                            <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1" class="form-control" id="exampleInputName1"
                                                placeholder="National ID Number" name="phone_number"
