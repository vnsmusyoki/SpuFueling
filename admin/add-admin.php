                                    ...
                                    <form class="forms-sample" action="" method="POST" autocomplete="off" ">
                                      <?php
                                        ...
                                        if (isset($_POST["createaccount"])) {
                                            ...
                                            require 'functions/add-admin-validation.php';
                                        }
                                        ?>
                                        <?php echo $message; ?>
                                        <div class=" row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputName1"
                                                    placeholder="eg. John Doe" name="fullname">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputName1"
                                                    placeholder="eg. exmaple@gmail.com" name="email">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="exampleInputName1"
                                                    placeholder="eg. 0123456789" name="phonenumber">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputName1"
                                                    placeholder="eg. johndoe" name="username">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="exampleInputName1"
                                                    placeholder="eg. johndoe" name="password">
                                            </div>
                                        </div>

                                </div>
                                <div class="form-group">
                                    <label for="exampleTextarea1">Home Residence</label>
                                    <textarea class="form-control" id="exampleTextarea1" rows="4"
                                        name="residence"></textarea>
                                </div>


                                <button type="submit" class="btn btn-gradient-primary mr-2" name="createaccount">Add
                                    Admin
                                </button>
