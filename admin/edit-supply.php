...
$bookingplans = "SELECT * FROM `supplies` where `supply_id` = '$supply'";
...
if ($bookingsplansrows >= 1) {
    while ($fetch  = mysqli_fetch_assoc($querybookingsplans)) {
        $globalid = $fetch['supply_id'];
        $globalsupplierid = $fetch['supply_supplier_id'];
        $globalcapacity = $fetch['supply_capacity'];
        $globaltankid = $fetch['supply_fuel_tank_id'];
        $globalcost = $fetch['supply_total_cost'];
        $date = $fetch['supply_date'];
        $globalcomments = $fetch['supply_comments'];

        global $globalid; global $globalsupplierid; global $globalcapacity; global $globaltankid; global $globalcost; global $date; global $globalcomments;
                        ...
                        <nav aria-label="breadcrumb">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span></span>Edit Existing Record <i
                            ...
                            <div class="card">
                                    ...
                                    <form class="forms-sample" action="" method="POST" autocomplete="off" ">
                                      <?php
                                        ...
                                        if (isset($_POST["createaccount"])) {
                                            ...
                                            require 'functions/edit-supply-validation.php';
                                        }
                                        ?>
                                        <?php echo $message; ?>
                                        <div class=" row">
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select name="supplier_id" id="" class="form-control"
                                                    selected="<?php echo $globalsupplierid; ?>">
                                        ...
                                        <div class=" col-3">
                                            <div class="form-group">
                                                ...
                                                <select name="tank_id" id="" class="form-control"
                                                    selected="<?php echo $globaltankid; ?>">
                                                    <option value="">click to select</option>
                                                    <?php
                                                    include '../db-conection.php';
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleTextarea1" rows="4"
                                        name="comments"><?php echo $globalcomments; ?></textarea>
                                </div>
